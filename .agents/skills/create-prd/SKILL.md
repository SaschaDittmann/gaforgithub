...
- Include information about framework, tools, libraries, etc. that should be used, by using the knowledge in the `docs/knowledge/` directory, and the `context7` MCP tools, and look for existing code in the `src/` directory.
</section-4-functional-requirements>
