...
- **Check `AGENTS.md`** for workflow and principles when working on tasks.
...
2. **Refine the Plan**: If a PRD exists, create a task list if it doesn't exist using the `create-tasks` skill.
3. **Verify Plan**: Check the PRD and task list before starting implementation
4. **Track Progress**: Mark items complete as you go
5. **Explain Changes**: High-level summary at each step
6. **Document Results**: Add review section to the task list you're working on in the `/docs/tasks/` folder
7. **Capture Lessons**: Create a learnings after any corrections, and after any changes using the `document-learnings` skill.
